...
const LETTERS: LetterData[] = [
  // Chapter 1: Difficult Days
  {
    ...
    body: [
      ...
      "You are never as alone as this moment feels. There are people — real, specific people — who think of you at odd hours. Who smile when your name comes up in conversation. Who save the funny thing that happened just to tell you later.",
      "I think of you when the chai overflows. When something absurd happens and my first instinct is to call you. When I hear a song we both know every word to.",
      "You carried a piece of home with you when you left. And you left a piece of yourself here. We're still whole — just scattered across a few more postcodes now.",
      "Go make yourself something warm. Wrap yourself in something soft. And know that your little sister is thinking of you tonight, sending every warm thing she has across the distance between us.",
    ],
  },
  {
